...
from src.adapters.discord_adapter.event_processing.discord_utils import is_discord_service_message
...
class IncomingEventProcessor(BaseIncomingEventProcessor):
    ...
    async def _handle_message(self, event: Any) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            initial_event_details = {"message": event, "attachments": attachments, "server": server}
