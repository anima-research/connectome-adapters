...
|----------------------|------------------------------------------|------------------------------------------------------------------------|
| conversation_started | New conversation initialized |{ <br>&nbsp;&nbsp;"adapter_type": str, <br>&nbsp;&nbsp;"event_type": "conversation_started", <br>&nbsp;&nbsp;"data": { <br>&nbsp;&nbsp;&nbsp;&nbsp;"adapter_name": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"adapter_id": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"conversation_id": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"conversation_name": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"server_name": str <br>&nbsp;&nbsp;} <br>}|
| conversation_updated | The change of conversation metadata |{ <br>&nbsp;&nbsp;"adapter_type": str, <br>&nbsp;&nbsp;"event_type": "conversation_started", <br>&nbsp;&nbsp;"data": { <br>&nbsp;&nbsp;&nbsp;&nbsp;"adapter_name": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"adapter_id": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"conversation_id": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"conversation_name": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"server_name": str <br>&nbsp;&nbsp;} <br>}|
| history_fetched      | The history of conversation |{ <br>&nbsp;&nbsp;"adapter_type": str, <br>&nbsp;&nbsp;"event_type": "conversation_started", <br>&nbsp;&nbsp;"data": { <br>&nbsp;&nbsp;&nbsp;&nbsp;"adapter_name": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"adapter_id": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"conversation_id": str, <br>&nbsp;&nbsp;&nbsp;&nbsp;"history": List[Dict] <br>&nbsp;&nbsp;} <br>}|
