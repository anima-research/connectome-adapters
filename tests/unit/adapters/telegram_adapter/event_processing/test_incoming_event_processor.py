...
from src.adapters.telegram_adapter.event_processing.incoming_event_processor import (
...
class TestIncomingEventProcessor:
    ...
    class TestHandleNewMessage:
        ...
        async def test_handle_new_message(self,
            ...
            with patch.object(UserInfoPreprocessor, "process_incoming_event", return_value={"user_id": "456"}):
