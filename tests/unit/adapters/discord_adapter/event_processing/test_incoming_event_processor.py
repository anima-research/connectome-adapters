...
from src.adapters.discord_adapter.event_processing.incoming_event_processor import (
...
class TestIncomingEventProcessor:
    ...
    def processor(self,
        ...
        processor = IncomingEventProcessor(discord_config, discord_client_mock, conversation_manager_mock)
    ...
    class TestHandleMessage:
        ...
        async def test_handle_message(self,
            ...
            processor._fetch_history = AsyncMock(return_value=[{"some": "history"}])
            ...
            processor.incoming_event_builder.history_fetched.assert_called_once_with(
                delta, processor._fetch_history.return_value
            )
    ...
    class TestHandleEditedMessage:
        ...
        async def test_handle_edited_message_content(self,
            ...
            with patch.object(UserInfoPreprocessor, "process_incoming_event", return_value={}):
                message = {
                    "conversation_id": "444555666/111222333",
                    "message_id": "123456789",
